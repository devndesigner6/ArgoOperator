...
const GooeyNav = ({
  ...
  const handleClick = (e, index) => {
    // Allow modifier-click / middle-click to open in a new tab natively.
    if (e && (e.metaKey || e.ctrlKey || e.shiftKey || e.altKey || e.button === 1)) {
      return;
    }
    ...
    if (onItemSelect) onItemSelect(items[index], index);
  };
